...
class ConsultaFirebase : JFrame() {
    ...
    init {
        ...
        val refCol = database.getReference("Alumne/alu_xx")
        ...
        refCol.addValueEventListener(object : ValueEventListener {
            override
            fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                colorG.setText(g)
                colorB.setText(b)
                canviColor(r,g,b)         // aquesta línia després la llevarem
            }
        ...
        botoCanvi.addActionListener {
            ...
            refCol.child("colorR").setValue(cR.toString(),null)
            refCol.child("colorG").setValue(cG.toString(),null)
            refCol.child("colorB").setValue(cB.toString(),null)
        }

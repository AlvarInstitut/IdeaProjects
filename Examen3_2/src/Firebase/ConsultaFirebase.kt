...
class ConsultaFirebase : JFrame() {
    ...
    init {
        ...
        val refColors = database.getReference("Alumnes/alu_00")
        ...
        refColors.addValueEventListener(object : ValueEventListener {
            override
            fun onDataChange(d: DataSnapshot) {
                canviColor(d.child("colorR").getValue().toString(),d.child("colorG").getValue().toString(),d.child("colorB").getValue().toString())
            }
        ...
        botoCanvi.addActionListener {
            ...
            refColors.setValue(colorins(cR.toString(),cG.toString(),cB.toString()),null)
        }
